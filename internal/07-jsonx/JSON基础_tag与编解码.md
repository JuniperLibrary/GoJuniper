...
- 测试代码：[jsonx_test.go](file:///e:/dingchuan/GoJuniper/internal/07-jsonx/jsonx_test.go)
...
请先看测试再看实现：
- 测试：[jsonx_test.go](file:///e:/dingchuan/GoJuniper/internal/07-jsonx/jsonx_test.go)
