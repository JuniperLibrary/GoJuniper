...
这个文档对应 [internal/12-syncx](file:///e:/dingchuan/GoJuniper/internal/12-syncx)。

配合阅读：
- 实现代码：[syncx.go](file:///e:/dingchuan/GoJuniper/internal/12-syncx/syncx.go)
- 测试代码：[syncx_test.go](file:///e:/dingchuan/GoJuniper/internal/12-syncx/syncx_test.go)
...
在本仓库里：
- [Counter](file:///e:/dingchuan/GoJuniper/internal/12-syncx/syncx.go#L8-L34) 用 `mu` 保护 `n`
...
本仓库的 [OnceValue](file:///e:/dingchuan/GoJuniper/internal/12-syncx/syncx.go#L36-L48) 就是一个典型练习：第一次计算后缓存，后续直接返回。
