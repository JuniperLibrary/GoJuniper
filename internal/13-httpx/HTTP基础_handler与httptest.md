...
这个文档对应 [internal/13-httpx](file:///e:/dingchuan/GoJuniper/internal/13-httpx)。

配合阅读：
- 实现代码：[httpx.go](file:///e:/dingchuan/GoJuniper/internal/13-httpx/httpx.go)
- 测试代码：[httpx_test.go](file:///e:/dingchuan/GoJuniper/internal/13-httpx/httpx_test.go)
...
本仓库用它构造一个简单的服务路由：[httpx.NewMux](file:///e:/dingchuan/GoJuniper/internal/13-httpx/httpx.go)
...
本仓库的测试就是这样写的：[httpx_test.go](file:///e:/dingchuan/GoJuniper/internal/13-httpx/httpx_test.go)
