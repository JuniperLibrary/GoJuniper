...
这个文档对应 [internal/10-concurrency](file:///e:/dingchuan/GoJuniper/internal/10-concurrency)。

配合阅读：
- 实现代码：[pool.go](file:///e:/dingchuan/GoJuniper/internal/10-concurrency/pool.go)
- 测试代码：[pool_test.go](file:///e:/dingchuan/GoJuniper/internal/10-concurrency/pool_test.go)
...
1. 先跑测试，理解期望行为：[pool_test.go](file:///e:/dingchuan/GoJuniper/internal/10-concurrency/pool_test.go)
2. 再读实现，看它如何监听 `ctx.Done()`：[pool.go](file:///e:/dingchuan/GoJuniper/internal/10-concurrency/pool.go)
