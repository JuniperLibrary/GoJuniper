...
这个文档对应 [internal/11-channelsx](file:///e:/dingchuan/GoJuniper/internal/11-channelsx)。

配合阅读：
- 实现代码：[channelsx.go](file:///e:/dingchuan/GoJuniper/internal/11-channelsx/channelsx.go)
- 测试代码：[channelsx_test.go](file:///e:/dingchuan/GoJuniper/internal/11-channelsx/channelsx_test.go)
...
对应函数：[Generate](file:///e:/dingchuan/GoJuniper/internal/11-channelsx/channelsx.go)
...
对应函数：[Square](file:///e:/dingchuan/GoJuniper/internal/11-channelsx/channelsx.go)
...
对应函数：[Merge](file:///e:/dingchuan/GoJuniper/internal/11-channelsx/channelsx.go)
