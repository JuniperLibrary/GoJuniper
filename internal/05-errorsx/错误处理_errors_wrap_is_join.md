...
这个文档对应 [internal/05-errorsx](file:///e:/dingchuan/GoJuniper/internal/05-errorsx)。

配合阅读：
- 实现代码：[errorsx.go](file:///e:/dingchuan/GoJuniper/internal/05-errorsx/errorsx.go)
- 测试代码：[errorsx_test.go](file:///e:/dingchuan/GoJuniper/internal/05-errorsx/errorsx_test.go)
...
```bash
go test ./internal/05-errorsx -shuffle on
```
